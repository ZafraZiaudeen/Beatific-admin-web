      ...
      <div className="hidden lg:flex flex-col overflow-hidden bg-[#F5F2EF] w-1/2 h-full border-r border-stone-200 pt-12 pr-12 pb-12 pl-12 relative justify-between">
        <div className="z-10">
          ...
          <p className="text-stone-500 max-w-sm text-lg">
            Manage templates, stickers, and user data in one unified workspace.
          </p>
        </div>
      ...
      <div className="w-full lg:w-1/2 h-full flex items-center justify-center p-8">
        <div className="w-full max-w-sm space-y-8">
          <div className="text-center">
            <h2 className="text-2xl font-semibold tracking-tight text-stone-900">Welcome back</h2>
            <p className="mt-2 text-sm text-stone-500">Enter your credentials to access the dashboard</p>
          </div>
          ...
          >
            ...
            >
              {loading ? (
                ...
                <>Sign In <span className="group-hover:translate-x-0.5 transition-transform">→</span></>
              )}
            </button>
          </form>
