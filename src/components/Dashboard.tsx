...
export default function Dashboard({ onEdit, onEditSticker, onViewTemplates, onViewStickers }: Props) {
  return (
      ...
      <div className="max-w-6xl mx-auto space-y-8">
        <div className="flex items-end justify-between">
          ...
          <div className="flex items-center gap-2">
            <button onClick={onEdit} className="px-4 py-2 bg-stone-900 text-white text-xs font-medium rounded-lg hover:bg-stone-800 transition-colors flex items-center gap-2">
              <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M12 5v14M5 12h14"/></svg>
              New Template
            </button>
            <button onClick={onEditSticker} className="px-4 py-2 bg-violet-600 text-white text-xs font-medium rounded-lg hover:bg-violet-700 transition-colors flex items-center gap-2">
              <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M12 5v14M5 12h14"/></svg>
              New Sticker
            </button>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <button onClick={onViewTemplates} className="bg-white p-5 rounded-xl border border-stone-200 shadow-sm text-left hover:border-sky-300 hover:shadow-md transition-all group">
            <div className="flex justify-between items-start mb-4">
            ...
            <h3 className="text-2xl font-semibold text-stone-900 group-hover:text-sky-700 transition-colors">Templates</h3>
            <p className="text-xs text-stone-500 mt-1">Click to manage →</p>
          </button>

          <button onClick={onViewStickers} className="bg-white p-5 rounded-xl border border-stone-200 shadow-sm text-left hover:border-violet-300 hover:shadow-md transition-all group">
            <div className="flex justify-between items-start mb-4">
            ...
            <h3 className="text-2xl font-semibold text-stone-900 group-hover:text-violet-700 transition-colors">Stickers</h3>
            <p className="text-xs text-stone-500 mt-1">Click to manage →</p>
          </button>
        </div>
        ...
        <div className="bg-white border border-stone-200 rounded-xl shadow-sm overflow-hidden">
          ...
          <div className="p-6 grid grid-cols-2 md:grid-cols-4 gap-3">
            ...
            >
              ...
              <span className="text-xs font-medium text-stone-700">New Template</span>
            </button>
            <button
              onClick={onEditSticker}
              className="flex flex-col items-center gap-2 p-4 rounded-xl border border-stone-200 hover:border-violet-300 hover:bg-violet-50 transition-all group"
            >
              <div className="w-10 h-10 rounded-lg bg-stone-100 group-hover:bg-violet-100 flex items-center justify-center transition-colors">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#64748b" strokeWidth="2"><circle cx="12" cy="12" r="10"/><path d="M12 8v8M8 12h8"/></svg>
              </div>
              <span className="text-xs font-medium text-stone-700">New Sticker</span>
            </button>
            <button
            ...
            >
              ...
              <span className="text-xs font-medium text-stone-700">All Templates</span>
            </button>
            <button
            ...
            >
              ...
              <span className="text-xs font-medium text-stone-700">All Stickers</span>
            </button>
          </div>
        </div>
      </div>
